...
def heatmap(df):
    ...
    os.makedirs('../results/{}/Heatmap'.format(time_toggle), exist_ok=True)
    plt.savefig("../results/{}/Heatmap/Figure{}.png".format(time_toggle, plt.gcf().number))
...
def pairplot(df):
    ...
    sns.pairplot(df)
    plt.tight_layout()
    os.makedirs('../results/{}/Pairplot'.format(time_toggle), exist_ok=True)
    plt.savefig("../results/{}/Pairplot/Figure{}.png".format(time_toggle, plt.gcf().number))
    ...
    for i in columns:
        for j, (x_col, y_col) in enumerate(column_combinations):
            if i != x_col and i != y_col:
                ...
                plt.tight_layout()
                os.makedirs('../results/{}/Scatterplot/{}'.format(time_toggle,i), exist_ok=True)
                plt.savefig("../results/{}/Scatterplot/{}/Figure{}.png".format(time_toggle, i, plt.gcf().number))
...
def catplot(df):
    ...
    for i in columns:
        ...
        plt.tight_layout()
        os.makedirs('../results/{}/Catplot/{}'.format(time_toggle,i), exist_ok=True)
        plt.savefig("../results/{}/Catplot/{}/Figure{}.png".format(time_toggle, i, plt.gcf().number))
